...
#Estória: APP-1358 (Solicitação de Reembolso - Parto)
#data criaçã: 08-06-2021
#Sprint: 6-Q2/2021
#Execução:

@APP-1358
Feature: solicitacao_de_reembolso_parto.feature
  ...
  Scenario: Exibir botão Exames na opção Selecionar procedimento
    ...
    Then Deve exibir a opção de seleção Selecionar o Tipo de procedimento "Parto"


  @APP-1358_2
  Scenario Outline: Campos 1 de 4 formulario Parto
    Given Que tenha passado pela tela de solicitação de reembolso
    When Selecionado o Tipo de procedimento "Parto"
  ...
  @APP-1358_4
  Scenario: Campos 2 de 4 formulario Parto(Disclamer)
    Given Que tenha passado pela tela de solicitação de reembolso
    When Selecionado o Tipo de procedimento "Parto"
  ...
  @APP-1358_5
  Scenario: Campos 2 de 4 formulario Parto
    Given Que tenha passado pela tela de solicitação de reembolso
    When Selecionado o Tipo de procedimento "Parto"
    And Preencher pagina do formulário "paginas_anteriores" e clicar em Proximo
    Then Exibir check box "Nota Fiscal ou recibo (Obrigatório)"
    And Logo abaixo a opção para anexar recibo ou nota fiscal
    And Exbir "Dados Complementares" com a opção para anexar "outros documentos" e "anexar prévia"
  ...
  Scenario: Testar funcionalidade anexo
    Given Que tenha iniciado o procedimento do formulario de reembolso para "Parto"
    When Selecionado o anexar um aquivo
    Then Deve exibir as opções "Tirar foto", "Selecionar da galeria", "Selecionar um arquivo"


  @APP-1358_7
  Scenario Outline: Campos 3 de 4 formulario Parto
    Given Que tenha passado pela tela de solicitação de reembolso
    When Selecionado o Tipo de procedimento "Parto"
    And Preencher pagina do formulário "paginas_anteriores" e clicar em Proximo
  ...
  @APP-1358_8
  Scenario Outline: Campos 4 de 4 formulario Parto
    Given Que tenha passado pela tela de solicitação de reembolso
    When Selecionado o Tipo de procedimento "Parto"
    And Preencher pagina do formulário "paginas_anteriores" e clicar em Proximo
  ...
  @APP-1358_9
  Scenario: Concluir formulario de reembolso para Parto
